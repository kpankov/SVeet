...
/**
 * @brief SV-specific Language Hierarchy
 */
public class SVLanguageHierarchy extends LanguageHierarchy<SVTokenId> {
    ...
    private static void init() {
        tokens = Arrays.asList(new SVTokenId[]{
            ...
            new SVTokenId("CLASS", "special", 34),
            ...
            new SVTokenId("FUNCTION", "special", 87),
            ...
            new SVTokenId("TASK", "special", 190),
            ...
            new SVTokenId("DELAY", "keyword", 241),
            new SVTokenId("IDENTIFIER", "identifier", 242),
            new SVTokenId("LETTER", "string", 243),
            new SVTokenId("PART_LETTER", "string", 244),
            new SVTokenId("LPAREN", "separator", 245),
            new SVTokenId("RPAREN", "separator", 246),
            new SVTokenId("LBRACE", "separator", 247),
            new SVTokenId("RBRACE", "separator", 248),
            new SVTokenId("LBRACKET", "separator", 249),
            new SVTokenId("RBRACKET", "separator", 250),
            new SVTokenId("SEMICOLON", "separator", 251),
            new SVTokenId("COMMA", "separator", 252),
            new SVTokenId("DOT", "separator", 253),
            new SVTokenId("AT", "special", 254),
            new SVTokenId("BLOCKINGASSIGN", "operator", 255),
            new SVTokenId("NONBLOCKINGASSIGN", "operator", 256),
            new SVTokenId("LT", "operator", 257),
            new SVTokenId("BANG", "operator", 258),
            new SVTokenId("TILDE", "operator", 259),
            new SVTokenId("HOOK", "operator", 260),
            new SVTokenId("COLON", "operator", 261),
            new SVTokenId("EQ", "operator", 262),
            new SVTokenId("LE", "operator", 263),
            new SVTokenId("GE", "operator", 264),
            new SVTokenId("NE", "operator", 265),
            new SVTokenId("SC_OR", "operator", 266),
            new SVTokenId("SC_AND", "operator", 267),
            new SVTokenId("INCR", "operator", 268),
            new SVTokenId("DECR", "operator", 269),
            new SVTokenId("PLUS", "operator", 270),
            new SVTokenId("MINUS", "operator", 271),
            new SVTokenId("STAR", "operator", 272),
            new SVTokenId("SLASH", "operator", 273),
            new SVTokenId("BIT_AND", "operator", 274),
            new SVTokenId("BIT_OR", "operator", 275),
            new SVTokenId("BIT_XOR", "operator", 276),
            new SVTokenId("REM", "operator", 277),
            new SVTokenId("LSHIFT", "operator", 278),
            new SVTokenId("PLUSASSIGN", "operator", 279),
            new SVTokenId("MINUSASSIGN", "operator", 280),
            new SVTokenId("STARASSIGN", "operator", 281),
            new SVTokenId("SLASHASSIGN", "operator", 282),
            new SVTokenId("ANDASSIGN", "operator", 283),
            new SVTokenId("ORASSIGN", "operator", 284),
            new SVTokenId("XORASSIGN", "operator", 285),
            new SVTokenId("REMASSIGN", "operator", 286),
            new SVTokenId("LSHIFTASSIGN", "operator", 287),
            new SVTokenId("RSIGNEDSHIFTASSIGN", "operator", 288),
            new SVTokenId("RUNSIGNEDSHIFTASSIGN", "operator", 289),
            new SVTokenId("GRAVE", "special", 290)
        });
