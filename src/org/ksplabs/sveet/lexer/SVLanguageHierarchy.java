...
public class SVLanguageHierarchy extends LanguageHierarchy<SVTokenId> {
    ...
    private static void init() {
        tokens = Arrays.asList(new SVTokenId[]{
            ...
            new SVTokenId("MODULE", "keyword", 123),
            ...
            new SVTokenId("NOSHOWCANCELLED", "keyword", ),
            new SVTokenId("NOT", "keyword", ),
            new SVTokenId("NOTIF0", "keyword", ),
            new SVTokenId("NOTIF1", "keyword", ),
            new SVTokenId("NULL", "keyword", ),
            new SVTokenId("OR", "keyword", ),
            new SVTokenId("OUTPUT", "keyword", ),
            new SVTokenId("PACKAGE", "keyword", ),
            new SVTokenId("PACKED", "keyword", ),
            new SVTokenId("PARAMETER", "keyword", ),
            new SVTokenId("PMOS", "keyword", ),
            new SVTokenId("POSEDGE", "keyword", ),
            new SVTokenId("PRIMITIVE", "keyword", ),
            new SVTokenId("PRIORITY", "keyword", ),
            new SVTokenId("PROGRAM", "keyword", ),
            new SVTokenId("PROPERTY", "keyword", ),
            new SVTokenId("PROTECTED", "keyword", ),
            new SVTokenId("PULL0", "keyword", ),
            new SVTokenId("PULL1", "keyword", ),
            new SVTokenId("PULLDOWN", "keyword", ),
            new SVTokenId("PULLUP", "keyword", ),
            new SVTokenId("PULSESTYLE_ONDETECT", "keyword", ),
            new SVTokenId("PULSESTYLE_ONEVENT", "keyword", ),
            new SVTokenId("PURE", "keyword", ),
            new SVTokenId("RAND", "keyword", ),
            new SVTokenId("RANDC", "keyword", ),
            new SVTokenId("RANDCASE", "keyword", ),
            new SVTokenId("RANDSEQUENCE", "keyword", ),
            new SVTokenId("RCMOS", "keyword", ),
            new SVTokenId("REAL", "keyword", ),
            new SVTokenId("REALTIME", "keyword", ),
            new SVTokenId("REF", "keyword", ),
            new SVTokenId("REG", "keyword", ),
            new SVTokenId("RELEASE", "keyword", ),
            new SVTokenId("REPEAT", "keyword", ),
            new SVTokenId("RETURN", "keyword", ),
            new SVTokenId("RNMOS", "keyword", ),
            new SVTokenId("RPMOS", "keyword", ),
            new SVTokenId("RTRAN", "keyword", ),
            new SVTokenId("RTRANIF0", "keyword", 168),
            new SVTokenId("RTRANIF1", "keyword", ),
            new SVTokenId("SCALARED", "keyword", ),
            new SVTokenId("SEQUENCE", "keyword", ),
            new SVTokenId("SHORTINT", "keyword", ),
            new SVTokenId("SHORTREAL", "keyword", ),
            new SVTokenId("SHOWCANCELLED", "keyword", ),
            new SVTokenId("SIGNED", "keyword", ),
            new SVTokenId("SMALL", "keyword", ),
            new SVTokenId("SOLVE", "keyword", ),
            new SVTokenId("SPECIFY", "keyword", ),
            new SVTokenId("SPECPARAM", "keyword", ),
            new SVTokenId("STATIC", "keyword", ),
            new SVTokenId("STRING", "keyword", ),
            new SVTokenId("STRONG0", "keyword", ),
            new SVTokenId("STRONG1", "keyword", ),
            new SVTokenId("STRUCT", "keyword", 184),
            new SVTokenId("SUPER", "keyword", ),
            new SVTokenId("SUPPLY0", "keyword", ),
            new SVTokenId("SUPPLY1", "keyword", ),
            new SVTokenId("TABLE", "keyword", ),
            new SVTokenId("TAGGED", "keyword", ),
            new SVTokenId("TASK", "keyword", ),
            new SVTokenId("THIS", "keyword", ),
            new SVTokenId("THROUGHOUT", "keyword", ),
            new SVTokenId("TIME", "keyword", ),
            new SVTokenId("TIMEPRECISION", "keyword", ),
            new SVTokenId("TIMEUNIT", "keyword", ),
            new SVTokenId("TRAN", "keyword", ),
            new SVTokenId("TRANIF0", "keyword", ),
            new SVTokenId("TRANIF1", "keyword", ),
            new SVTokenId("TRI", "keyword", ),
            new SVTokenId("TRI0", "keyword", ),
            new SVTokenId("TRI1", "keyword", ),
            new SVTokenId("TRIAND", "keyword", 202),
            new SVTokenId("TRIOR", "keyword", ),
            new SVTokenId("TRIREG", "keyword", ),
            new SVTokenId("TYPE", "keyword", ),
            new SVTokenId("TYPEDEF", "keyword", ),
            new SVTokenId("UNION", "keyword", ),
            new SVTokenId("UNIQUE", "keyword", ),
            new SVTokenId("UNSIGNED", "keyword", ),
            new SVTokenId("USE", "keyword", ),
            new SVTokenId("UWIRE", "keyword", ),
            new SVTokenId("VAR", "keyword", ),
            new SVTokenId("VECTORED", "keyword", ),
            new SVTokenId("VIRTUAL", "keyword", ),
            new SVTokenId("VOID", "keyword", ),
            new SVTokenId("WAIT", "keyword", ),
            new SVTokenId("WAIT_ORDER", "keyword", ),
            new SVTokenId("WAND", "keyword", ),
            new SVTokenId("WEAK0", "keyword", ),
            new SVTokenId("WEAK1", "keyword", ),
            new SVTokenId("WHILE", "keyword", ),
            new SVTokenId("WILDCARD", "keyword", ),
            new SVTokenId("WIRE", "keyword", ),
            new SVTokenId("WITH", "keyword", ),
            new SVTokenId("WITHIN", "keyword", ),
            new SVTokenId("WOR", "keyword", ),
            new SVTokenId("XNOR", "keyword", ),
            new SVTokenId("XOR", "keyword", ),
            ...
            new SVTokenId("XOR", "operator", 275),
